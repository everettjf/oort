...
[![网站](https://img.shields.io/badge/网站-everettjf.github.io%2Fopenorb-3ee0c5)](https://everettjf.github.io/openorb/)
...
🌐 **[网站 &amp; 教程 → everettjf.github.io/openorb](https://everettjf.github.io/openorb/)**
...
| 🛰️ **`oorb` CLI** | 生命周期、`oorb exec`、docker 透传、`oorb autostart` 开机自启 | ✅ |
...
```
   ...
   │  docker CLI / oorb                          │        │  openorb-guest（Go，编译二进制）：     │
...
| [命令参考](./docs/cli-reference.zh-CN.md) | `oorb` 全部子命令 + `openorb run` 全部参数 |
