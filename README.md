...
[![版本](https://img.shields.io/badge/版本-v0.1.0-green)](./CHANGELOG.md)
...
更详细的步骤见 **[docs/快速开始.md](./docs/快速开始.md)**。
...
> 以及 **[docs/架构与原理.md](./docs/架构与原理.md)**。
...
| 文档 | 内容 |
|---|---|
| [快速开始](./docs/快速开始.md) | 安装、首次运行、常用操作 |
| [架构与原理](./docs/架构与原理.md) | VZ / vsock / VirtioFS / Rosetta / 端口转发 / Go agent 的实现原理 |
| [命令参考](./docs/命令参考.md) | `orb` 全部子命令 + `openorb run` 全部参数 |
| [常见问题](./docs/常见问题.md) | FAQ 与排错（DNS、zram、provisioning、与 Docker Desktop 共存等） |
...
- 与 Docker Desktop 共存时注意 `DOCKER_HOST`/`docker context`，详见[常见问题](./docs/常见问题.md)。
