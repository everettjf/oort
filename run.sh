...
BIN="$(swift build -c "$CONFIG" --show-bin-path)/openorb"
echo "==> codesign (ad-hoc) with $PWD/openorb.entitlements"
codesign --force --sign - --entitlements ./openorb.entitlements "$BIN"
